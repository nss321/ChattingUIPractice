...
let mockChatList: [ChatRoom] = [
    ...
    ChatRoom(chatroomId: 6,
             chatroomImage: [User.other_friend.profileImage, User.jack.profileImage, User.bran.profileImage],
             chatroomName: "쓱쓱 4조 단톡",
             chatList: [
                Chat(user: .user,
                     date: "2025-01-12 10:30",
                ...
                Chat(user: .jack,
                     date: "2025-01-12 11:08",
                     message: "제 명강의를 그렇게 듣고도 아직이시라니.."),
                Chat(user: .jack,
                     date: "2025-01-12 11:09",
                     message: "아무래도 과제가 부족한 것 같습니다."),
                Chat(user: .jack,
                     date: "2025-01-12 11:09",
                     message: "추가 과제 나가겠습니다 !!"),
                Chat(user: .user,
                     date: "2025-01-12 11:10",
                     message: "우...와..."),
                Chat(user: .other_friend,
                     date: "2025-01-12 11:12",
                     message: "와! 과제! 새싹을 뒤집어 놓으셔따!"),
                Chat(user: .bran,
                     date: "2025-01-12 11:16",
                     message: "ㅋㅋ와 부럽당 나도 과제하고 싶다~"),
                Chat(user: .other_friend,
    ...
    ChatRoom(chatroomId: 7,
             chatroomImage: [User.simsim.profileImage, User.hue.profileImage],
             chatroomName: "취업 쓱싹",
             chatList: [
                Chat(user: .user,
                ...
                Chat(user: .hue,
                     date: "2025-01-11 09:32",
                     message: "이번에도 취업 못하면 많이 슬프겠다. 그쵸?"),
                Chat(user: .user,
                ...
                Chat(user: .user,
                     ...
                     message: "기어코 너도 과제 하다가 망가져 버렸군아,,,"),
                Chat(user: .simsim,
